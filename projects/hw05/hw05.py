...
class Account:
    ...
    def time_to_retire(self, amount):
        ...
        n = 0
        while True:
            if self.balance  * (1 + self.interest)**n < amount:
                n += 1
            else:
                break
        return n
...
def make_withdraw(balance, password):
    ...
    def withdraw(amount,string):
        ...
        if len(l) < 3:
            ...
            return "Your account is locked. Attempts: {}".format(l)
...
def make_joint(withdraw, old_password, new_password):
    ...
    """
    "*** YOUR CODE HERE ***"
    def joint(amount, string):
        nonlocal withdraw, old_password, new_password
